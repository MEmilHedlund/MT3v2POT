...
class MT3V2(nn.Module):
    def __init__(self, params):
        super().__init__()
        self.params = params
        self.d_detections = params.arch.d_detections #dimensionality? r, vr, phi
        ...
        self.measurement_normalization_factor = torch.tensor(\
                [params.data_generation.field_of_view.max_range - params.data_generation.field_of_view.min_range,
                 ...
                 params.data_generation.field_of_view.max_theta - params.data_generation.field_of_view.min_theta], 
        ...
        self.prediction_space_dimensions = 2 # (xy1,xy2,xy3,xy4,vxy)  #2  # (x, y) position and velocity
        self.pos_vel_predictor = MLP(params.arch.d_model,
                                     hidden_dim=params.arch.d_prediction_hidden,
                                     output_dim=self.prediction_space_dimensions*2, #Splits xy1 to (x1, y1)
    ...
    def gen_encoder_output_proposals(self, embeddings, memory_padding_mask, normalized_measurements):
        ...
        return projected_embeddings, normalized_measurements_presigmoid #Kan hända att vi måste ändra dimsen på dessa outs om vi vill ha fler än 4 dims?
    ...
    def get_two_stage_proposals(self, measurement_batch, embeddings):
        ...
        projected_embeddings, normalized_meas_presigmoid = \
            self.gen_encoder_output_proposals(embeddings.permute(1, 0, 2), measurement_batch.mask, normalized_xy_meas)
    ...
    def forward(self, measurements: NestedTensor):
        ...
        preprocessed_measurements = self.preprocessor(measurements.tensors[:, :, :self.d_detections]) # FFN
        ...
        # Pack output using standardized Prediction class #PREDICTIONS#PREDICTIONS#PREDICTIONS
