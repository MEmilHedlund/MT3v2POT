...
from util.carla_to_mt3 import extract_json, unpack_data_extended, unpack_data_point
...
class DataGenerator:
    ...
    def get_batch(self):
        ...
        data_detections, data_truth = extract_json("*140657", n_batches=2, time_steps=20)
